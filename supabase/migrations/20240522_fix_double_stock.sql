...
DROP TRIGGER IF EXISTS on_purchase_stock_update ON purchases; -- My new one (will recreate)
...
DROP TRIGGER IF EXISTS on_sale_stock_update ON sales; -- My new one (will recreate)
...
-- Re-create the correct function (just to be safe and ensure it's the latest version)
